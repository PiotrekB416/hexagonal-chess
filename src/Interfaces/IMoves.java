...
public interface IMoves extends IValidate, IHashMaps {
    default HashMap<Integer, int[]> generateNeighboringMap(int file){
    ...
    default ArrayList<Integer> generateMovesFromArray(Board board, int[][] moveArray, int rank, String file, boolean rep, boolean validate){
